...
import argparse
import platform
tmp_dir = '' if platform.system() == 'Windows' else 'src/SigmaDiff/out'
...
if __name__ == "__main__":
    ...
    #filename = args.f
    folder1 = 'Zoom-5.9.31911_libturbojpegstripped.so' # the decompiled code of the first binary is stored here
    folder2 = 'turbojpeg-2.1.2_libturbojpegstripped.so' # the decompiled code of the second binary is stored here
    ...
    path = 'Zoom-5.9.31911_libturbojpegstripped.so_vs_turbojpeg-2.1.2_libturbojpegstripped.so\matched_functions.txt'
    with open(path, "r") as f:
        lines = f.readlines()
        for line in lines:
