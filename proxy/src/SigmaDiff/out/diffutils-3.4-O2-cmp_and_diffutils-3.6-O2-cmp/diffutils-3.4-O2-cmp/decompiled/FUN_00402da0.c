1: 
2: undefined8 FUN_00402da0(byte *param_1,undefined8 param_2)
3: 
4: {
5: byte bVar1;
6: ushort uVar2;
...
37: __s = (byte *)FUN_00403ae0(param_2,2);
38: LAB_00402df0:
39: if (*param_1 != 0) {
40: while( true ) {
41: pbVar6 = (byte *)FUN_00406120(param_1,__s);
42: if (pbVar6 == (byte *)0x0) goto LAB_00403040;
...
51: if (bVar1 != 0) goto LAB_0040358a;
52: LAB_00403023:
53: if (bVar10 != 0) goto LAB_004036d2;
54: }
55: else {
56: sVar7 = strlen((char *)__s);
57: bVar1 = pbVar6[sVar7];
58: if (bVar1 == 0) goto LAB_004036d2;
59: bVar10 = 1;
60: LAB_0040358a:
61: ppuVar8 = __ctype_b_loc();
62: if ((*(byte *)(*ppuVar8 + bVar1) & 8) == 0) goto LAB_00403023;
63: }
64: if ((*pbVar6 == 0) || (param_1 = pbVar6 + 1, *param_1 == 0)) goto LAB_00403040;
65: }
66: bVar14 = false;
...
75: pbVar4 = local_b8;
76: uVar9 = FUN_00403aa0(local_b8,sVar7);
77: local_b0 = FUN_00404fc0(local_a4,pbVar4,uVar9,&local_c4);
...
111: if (iVar5 == 0) goto LAB_00402e8d;
112: }
113: bVar14 = false;
114: goto LAB_00402e8d;
115: }
...
121: }
122: else {
123: if ((*(uint *)(&DAT_00408cc0 + (ulong)(*local_b8 >> 5) * 4) >> (*local_b8 & 0x1f) & 1) ==
124: 0) {
125: iVar5 = mbsinit(&local_c4);
126: if (iVar5 != 0) {
127: bVar14 = true;
128: goto LAB_00402ec7;
129: }
130: goto LAB_004036dc;
131: }
132: local_b0 = 1;
...
136: LAB_00402e8d:
137: local_bc = '\x01';
138: if (wVar13 == 0) goto LAB_00402f50;
139: }
...
158: local_7c = 0;
159: local_bc = '\0';
160: if ((*(uint *)(&DAT_00408cc0 + (ulong)(*local_78 >> 5) * 4) >> (*local_78 & 0x1f) & 1) != 0) {
161: local_70 = 1;
162: local_64[0] = (int)(char)*local_78;
163: local_68 = 1;
164: goto LAB_00403126;
165: }
...
171: pbVar4 = local_78;
172: uVar9 = FUN_00403aa0(local_78,sVar7);
173: local_70 = FUN_00404fc0(local_64,pbVar4,uVar9,&local_84);
...
182: goto LAB_00403249;
183: }
184: if (local_70 == 0) {
185: local_70 = 1;
186: if (*local_78 != 0) goto LAB_004036f5;
187: if (local_64[0] != 0) goto LAB_00403661;
188: }
189: local_68 = 1;
...
204: pbVar4 = local_b8;
205: uVar9 = FUN_00403aa0(local_b8,sVar7);
206: local_b0 = FUN_00404fc0(local_a4,pbVar4,uVar9,&local_c4);
...
219: if (local_b0 == 0) {
220: local_b0 = 1;
221: if (*local_b8 != 0) goto LAB_004036f5;
222: if (local_a4[0] != 0) goto LAB_00403661;
223: }
224: local_a8 = '\x01';
225: cVar11 = '\x01';
...
229: }
230: else {
231: if ((*(uint *)(&DAT_00408cc0 + (ulong)(*local_b8 >> 5) * 4) >> (*local_b8 & 0x1f) &
232: 1) == 0) {
233: iVar5 = mbsinit(&local_c4);
234: if (iVar5 != 0) goto LAB_004035b9;
235: goto LAB_004036dc;
236: }
237: local_b0 = 1;
...
247: (iVar5 = iswalnum(wVar13), iVar5 == 0)) && (bVar14)) goto LAB_004036d2;
248: local_c4 = (mbstate_t)0x0;
249: local_bc = '\0';
250: if ((*(uint *)(&DAT_00408cc0 + (ulong)(*pbVar6 >> 5) * 4) >> (*pbVar6 & 0x1f) & 1) == 0)
251: {
252: local_b8 = pbVar6;
253: iVar5 = mbsinit(&local_c4);
254: if (iVar5 == 0) goto LAB_004036dc;
255: sVar7 = __ctype_get_mb_cur_max();
256: pbVar4 = local_b8;
257: uVar9 = FUN_00403aa0(local_b8,sVar7);
258: local_b0 = FUN_00404fc0(local_a4,pbVar4,uVar9);
259: if (local_b0 == 0xffffffffffffffff) {
260: local_b0 = 1;
261: param_1 = pbVar6 + 1;
262: goto LAB_00402df0;
263: }
264: if (local_b0 == 0xfffffffffffffffe) {
265: local_b0 = strlen((char *)local_b8);
266: param_1 = pbVar6 + local_b0;
267: goto LAB_00402df0;
268: }
269: if (local_b0 == 0) {
270: local_b0 = 1;
271: if (*local_b8 != 0) goto LAB_004036f5;
272: if (local_a4[0] != 0) goto LAB_00403661;
273: }
274: local_a8 = '\x01';
...
282: }
283: local_bc = '\x01';
284: if (local_a4[0] == 0) goto LAB_00403040;
285: param_1 = pbVar6 + local_b0;
286: goto LAB_00402df0;
287: }
288: }
289: cVar12 = local_bc;
290: local_7c = 1;
...
296: pbVar4 = local_b8;
297: uVar9 = FUN_00403aa0(local_b8,sVar7);
298: local_b0 = FUN_00404fc0(local_a4,pbVar4,uVar9,&local_c4);
...
309: if (local_b0 == 0) {
310: local_b0 = 1;
311: if (*local_b8 != 0) goto LAB_004036f5;
312: if (local_a4[0] != 0) goto LAB_00403661;
313: }
314: local_a8 = '\x01';
315: cVar12 = '\x01';
...
322: }
323: else {
324: if ((*(uint *)(&DAT_00408cc0 + (ulong)(*local_b8 >> 5) * 4) >> (*local_b8 & 0x1f) & 1)
325: == 0) {
326: iVar5 = mbsinit(&local_c4);
327: if (iVar5 != 0) {
328: bVar3 = true;
329: goto LAB_004033a5;
330: }
331: goto LAB_004036dc;
332: }
333: local_b0 = 1;
...
339: cVar11 = cVar12;
340: }
341: if ((cVar11 != '\0') && (local_a4[0] == 0)) goto LAB_00402f50;
