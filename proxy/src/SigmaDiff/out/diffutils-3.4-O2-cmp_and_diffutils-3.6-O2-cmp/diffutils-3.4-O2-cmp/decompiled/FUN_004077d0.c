1: 
2: size_t FUN_004077d0(byte *param_1)
3: 
4: {
5: bool bVar1;
6: byte *pbVar2;
...
30: LAB_00407828:
31: local_5c = 0;
32: if ((*(uint *)(&DAT_00408cc0 + (ulong)(*local_58 >> 5) * 4) >> (*local_58 & 0x1f) & 1) == 0) {
33: iVar3 = mbsinit(&local_64);
34: if (iVar3 != 0) {
35: bVar1 = true;
36: goto LAB_004078bb;
37: }
...
49: local_5c = 0;
50: if (!bVar1) goto LAB_00407828;
51: LAB_004078bb:
52: sVar5 = __ctype_get_mb_cur_max();
53: pbVar2 = local_58;
54: uVar6 = FUN_00403aa0(local_58,sVar5);
55: local_50 = FUN_00404fc0(local_44,pbVar2,uVar6,&local_64);
