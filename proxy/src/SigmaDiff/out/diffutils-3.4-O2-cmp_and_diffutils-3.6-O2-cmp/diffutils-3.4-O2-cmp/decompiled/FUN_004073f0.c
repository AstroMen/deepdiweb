1: 
2: char * FUN_004073f0(char *param_1,iconv_t param_2)
3: 
4: {
5: char *__ptr;
6: size_t sVar1;
...
35: if (*piVar2 != 7) goto LAB_004075a7;
36: pcVar5 = (char *)((long)pcVar3 * 2);
37: pcVar4 = local_50 + -(long)__ptr;
38: if ((pcVar5 <= pcVar3) ||
39: (pcVar3 = (char *)realloc(__ptr,(size_t)pcVar5), pcVar3 == (char *)0x0)) goto LAB_004075a0;
...
47: if (sVar1 != 0xffffffffffffffff) goto code_r0x0040756b;
48: piVar2 = __errno_location();
49: if (*piVar2 != 7) goto LAB_004075a7;
50: pcVar5 = (char *)((long)pcVar3 * 2);
51: pcVar4 = local_50 + -(long)__ptr;
52: if ((pcVar5 <= pcVar3) ||
53: (pcVar3 = (char *)realloc(__ptr,(size_t)pcVar5), pcVar3 == (char *)0x0)) goto LAB_004075a0;
...
76: pcVar4 = __ptr;
77: }
78: goto LAB_004075b1;
79: LAB_004075a0:
80: *piVar2 = 0xc;
81: LAB_004075a7:
82: free(__ptr);
83: pcVar4 = (char *)0x0;
84: goto LAB_004075b1;
85: }
86: 
