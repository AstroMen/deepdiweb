1: 
2: byte * FUN_00403ae0(undefined8 param_1,int param_2)
3: 
4: {
5: byte bVar1;
6: ushort *puVar2;
...
47: if (param_2 == 1) goto LAB_00403db9;
48: }
...
73: if (bVar3) {
74: LAB_00403f42:
75: local_68 = (byte *)FUN_00404fc0(local_5c,pbVar8,pbVar9 + -(long)pbVar8);
76: pbVar8 = local_70;
...
84: if (*local_70 != 0) goto LAB_00404032;
85: if (local_5c[0] != 0) goto LAB_00404050;
86: }
87: local_60 = '\x01';
...
98: break;
99: }
100: if ((*(uint *)(&DAT_00408cc0 + (ulong)(*pbVar8 >> 5) * 4) >> (*pbVar8 & 0x1f) & 1) == 0) {
101: iVar5 = mbsinit(&local_7c);
102: if (iVar5 != 0) {
103: bVar3 = true;
104: goto LAB_00403f42;
105: }
106: goto LAB_00404014;
107: }
...
123: if (param_2 == 1) goto LAB_00403db9;
124: }
125: cVar10 = '\0';
126: local_70 = __s;
...
136: if (bVar3) {
137: LAB_00403c55:
138: local_68 = (byte *)FUN_00404fc0(local_5c,pbVar8,pbVar9 + -(long)pbVar8);
139: pbVar8 = local_70;
...
172: }
173: else {
174: if ((*(uint *)(&DAT_00408cc0 + (ulong)(*pbVar8 >> 5) * 4) >> (*pbVar8 & 0x1f) & 1) == 0) {
