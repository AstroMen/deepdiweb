1: 
2: undefined8 FUN_00407180(char *param_1,size_t param_2,iconv_t param_3,char **param_4,char **param_5)
3: 
4: {
5: int iVar1;
6: size_t sVar2;
...
31: if (*piVar3 != 7) {
32: if (*piVar3 != 0x16) goto LAB_00407387;
33: break;
34: }
35: }
...
57: do {
58: if (local_1060 == 0) goto LAB_004072fc;
