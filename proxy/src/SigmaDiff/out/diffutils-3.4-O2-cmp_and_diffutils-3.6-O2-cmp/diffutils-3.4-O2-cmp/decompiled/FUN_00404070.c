1: 
2: undefined8
3: FUN_00404070(FILE *param_1,long param_2,undefined8 param_3,undefined8 param_4,undefined8 *param_5,
...
25: }
26: uVar1 = dcgettext(0,&DAT_00408535,5);
27: __fprintf_chk(param_1,1,"Copyright %s %d Free Software Foundation, Inc.",uVar1,0x7e0);
...
101: uVar5 = param_5[3];
102: uVar7 = *param_5;
103: local_40 = 0x40414e;
104: uVar3 = dcgettext(0,"Written by %s, %s, %s,\n%s, %s, %s, %s,\nand %s.\n",5);
105: goto LAB_00404152;
106: case 9:
