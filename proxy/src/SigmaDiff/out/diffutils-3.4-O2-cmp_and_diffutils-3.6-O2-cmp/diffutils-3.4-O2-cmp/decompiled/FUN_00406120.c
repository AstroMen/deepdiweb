...
3: 
4: byte * FUN_00406120(byte *param_1,byte *param_2)
5: 
6: {
7: byte bVar1;
8: byte *pbVar2;
...
92: uVar15 = uVar11;
93: if (*pbVar13 != 0) goto LAB_004063fe;
94: }
95: sVar7 = strlen((char *)param_2);
96: cVar5 = FUN_00405560(pbVar2,param_2,sVar7);
97: pbVar8 = local_190;
98: if (cVar5 != '\0') goto LAB_004064e0;
99: pbVar13 = (byte *)0x0;
100: bVar3 = false;
101: }
102: }
...
104: if (bVar1 == *pbVar2) {
105: pbVar8 = pbVar2;
106: if (param_2[1] == 0) goto LAB_004064e0;
107: if (*param_1 == 0) goto LAB_00406510;
108: uVar10 = uVar11 + 2;
109: if (*param_1 == param_2[1]) {
110: do {
111: lVar12 = uVar10 + -uVar11;
112: if (param_2[lVar12] == 0) goto LAB_004064e0;
113: lVar4 = uVar10 + -uVar11;
114: if (pbVar2[lVar4] == 0) goto LAB_00406510;
115: uVar10 = uVar10 + 1;
116: } while (param_2[lVar12] == pbVar2[lVar4]);
117: }
118: goto LAB_004063b4;
119: }
120: if (*param_1 != 0) {
121: uVar10 = uVar11 + 1;
122: goto LAB_004063b4;
123: }
124: }
125: LAB_00406510:
126: pbVar8 = (byte *)0x0;
127: }
128: goto LAB_004064e0;
129: }
130: bVar1 = *param_2;
131: local_188 = 0;
...
135: if ((*(uint *)(&DAT_00408cc0 + (ulong)(bVar1 >> 5) * 4) >> ((int)(char)bVar1 & 0x1fU) & 1) == 0) {
...
145: uVar9 = FUN_00403aa0(local_178,sVar7);
146: local_170 = FUN_00404fc0(local_164,pbVar13,uVar9,&local_184);
...
208: if ((*(uint *)(&DAT_00408cc0 + (ulong)(*local_f8 >> 5) * 4) >> (*local_f8 & 0x1f) & 1) == 0) {
209: iVar6 = mbsinit(&mStack260);
210: if (iVar6 != 0) {
211: local_108 = CONCAT31(local_108._1_3_,1);
212: goto LAB_00406591;
213: }
214: goto LAB_004070fd;
215: }
216: local_f0 = 1;
...
221: if (uStack228 == 0) goto LAB_00406510;
222: if ((uVar15 < 10) || (!bVar3)) {
223: LAB_00406805:
224: local_1c0 = uVar10;
225: if (local_168 == '\0') goto LAB_00406de0;
226: sVar7 = local_f0;
227: uVar10 = local_1c0;
228: uVar11 = uVar14 + 1;
229: if (uStack228 != local_164[0]) goto LAB_00406a39;
230: LAB_00406821:
231: uVar11 = uVar14 + 1;
...
245: if ((*(uint *)(&DAT_00408cc0 + (ulong)(bVar1 >> 5) * 4) >> ((int)(char)bVar1 & 0x1fU) & 1)
246: == 0) {
247: iVar6 = mbsinit(&local_84);
248: if (iVar6 == 0) goto LAB_004070fd;
249: local_88 = '\x01';
250: sVar7 = __ctype_get_mb_cur_max();
251: pbVar8 = local_78;
252: uVar9 = FUN_00403aa0(local_78,sVar7);
253: local_70 = FUN_00404fc0(local_64,pbVar8,uVar9,&local_84);
254: if (local_70 == 0xffffffffffffffff) {
255: local_70 = 1;
256: local_68 = '\0';
257: goto LAB_00406439;
258: }
259: if (local_70 == 0xfffffffffffffffe) {
260: local_70 = strlen((char *)local_78);
261: local_68 = '\0';
262: goto LAB_00406439;
263: }
264: if (local_70 == 0) {
265: local_70 = 1;
266: if (*local_78 != 0) goto LAB_00407163;
267: if (local_64[0] != 0) goto LAB_00406ec1;
268: }
269: local_68 = '\x01';
...
289: uVar11 = uVar11 + 1;
290: if (local_88 == '\0') {
291: if ((*(uint *)(&DAT_00408cc0 + (ulong)(*local_78 >> 5) * 4) >> (*local_78 & 0x1f) & 1)
292: == 0) {
293: iVar6 = mbsinit(&local_84);
294: if (iVar6 != 0) {
295: local_88 = '\x01';
296: goto LAB_00406ba0;
297: }
298: goto LAB_004070fd;
299: }
300: local_70 = 1;
...
304: local_7c = 1;
305: pbVar8 = local_f8;
306: if (local_64[0] == 0) goto LAB_004064e0;
307: }
308: else {
309: LAB_00406ba0:
310: sVar7 = __ctype_get_mb_cur_max();
311: pbVar8 = local_78;
312: uVar9 = FUN_00403aa0(local_78,sVar7);
313: local_70 = FUN_00404fc0(local_64,pbVar8,uVar9,&local_84);
...
319: if (local_70 == 0) {
320: local_70 = 1;
321: if (*local_78 != 0) goto LAB_00407163;
322: if (local_64[0] != 0) goto LAB_00406ec1;
323: }
324: local_68 = '\x01';
...
338: if (local_c8[0] == '\0') {
339: if ((*(uint *)(&DAT_00408cc0 + (ulong)(*local_b8 >> 5) * 4) >> (*local_b8 & 0x1f) & 1)
340: == 0) {
341: iVar6 = mbsinit((mbstate_t *)(local_c8 + 4));
342: if (iVar6 != 0) {
343: local_c8 = CONCAT71(local_c8._1_7_,1);
344: goto LAB_00406c5a;
345: }
346: goto LAB_004070fd;
347: }
348: local_b0 = 1;
...
356: pbVar8 = local_b8;
357: uVar9 = FUN_00403aa0(local_b8,sVar7);
358: local_b0 = FUN_00404fc0((long)&local_a8 + 4,pbVar8,uVar9,local_c8 + 4);
...
369: if (local_b0 == 0) {
370: local_b0 = 1;
371: if (*local_b8 != 0) goto LAB_00407163;
372: if (local_a8._4_4_ != 0) goto LAB_00406ec1;
373: }
...
385: if (local_c0._4_1_ != '\0') goto LAB_00406b58;
386: LAB_00406aba:
387: sVar7 = local_f0;
388: if (local_b0 != local_70) goto LAB_00406a39;
389: iVar6 = memcmp(local_b8,local_78,local_b0);
390: bVar16 = iVar6 != 0;
391: }
392: else {
393: if ((char)local_a8 == '\0') goto LAB_00406aba;
394: LAB_00406b58:
395: if (local_a8._4_4_ == 0) goto LAB_00406510;
396: if (local_68 == '\0') goto LAB_00406aba;
397: bVar16 = local_64[0] != local_a8._4_4_;
398: }
399: sVar7 = local_f0;
400: if (bVar16) goto LAB_00406a39;
...
407: bVar3 = true;
408: goto LAB_00406805;
409: }
410: LAB_004066e9:
411: lVar12 = local_1c0 - uVar10;
412: if (lVar12 == 0) {
413: cVar5 = local_128;
414: if (local_13c == '\0') goto LAB_00406f10;
415: LAB_00406f73:
416: if ((cVar5 != '\0') && (local_124[0] == 0)) goto LAB_004067cd;
417: bVar3 = true;
418: }
419: else {
420: if (local_13c == '\0') goto LAB_00406746;
421: if (local_128 != '\0') goto LAB_004067ae;
422: do {
423: do {
424: local_138 = local_138 + local_130;
425: lVar12 = lVar12 + -1;
426: local_13c = '\0';
427: if (lVar12 == 0) goto LAB_00406f10;
428: LAB_00406746:
429: cVar5 = local_13c;
430: if (local_148 == '\0') {
431: if ((*(uint *)(&DAT_00408cc0 + (ulong)(*local_138 >> 5) * 4) >> (*local_138 & 0x1f) &
432: 1) == 0) {
433: iVar6 = mbsinit(&local_144);
434: if (iVar6 != 0) {
435: local_148 = '\x01';
436: goto LAB_0040694a;
437: }
438: goto LAB_004070fd;
439: }
440: local_130 = 1;
...
449: uVar9 = FUN_00403aa0(local_138,sVar7);
450: local_130 = FUN_00404fc0(local_124,pbVar8,uVar9);
...
461: if (local_130 == 0) {
462: local_130 = 1;
463: if (*local_138 != 0) goto LAB_00407163;
464: if (local_124[0] != 0) goto LAB_00406ec1;
465: }
466: local_128 = '\x01';
467: cVar5 = '\x01';
...
480: LAB_00406f10:
481: if (local_148 == '\0') {
482: if ((*(uint *)(&DAT_00408cc0 + (ulong)(*local_138 >> 5) * 4) >> (*local_138 & 0x1f) & 1)
483: == 0) {
484: iVar6 = mbsinit(&local_144);
485: if (iVar6 != 0) {
486: local_148 = '\x01';
487: goto LAB_00406fca;
488: }
489: goto LAB_004070fd;
490: }
491: local_130 = 1;
...
500: uVar9 = FUN_00403aa0(local_138,sVar7);
501: local_130 = FUN_00404fc0(local_124,pbVar8,uVar9);
...
514: if (local_130 == 0) {
515: local_130 = 1;
516: if (*local_138 != 0) goto LAB_00407163;
517: if (local_124[0] != 0) goto LAB_00406ec1;
518: }
519: local_128 = '\x01';
...
527: }
528: local_13c = '\x01';
529: goto LAB_00406f73;
530: }
531: LAB_004067cd:
532: cVar5 = FUN_00405700(param_1,param_2,&local_190);
533: pbVar8 = local_190;
534: if (cVar5 != '\0') goto LAB_004064e0;
535: bVar3 = false;
536: }
537: uVar10 = local_1c0;
538: if ((char)local_e8 != '\0') goto LAB_00406805;
539: LAB_00406de0:
540: sVar7 = local_f0;
541: uVar10 = local_1c0;
542: uVar11 = uVar14 + 1;
543: if (local_f0 == local_170) goto LAB_00406e00;
544: }
545: else {
546: LAB_00406591:
547: sVar7 = __ctype_get_mb_cur_max();
548: pbVar8 = local_f8;
549: uVar9 = FUN_00403aa0(local_f8,sVar7);
550: local_f0 = FUN_00404fc0(&uStack228,pbVar8,uVar9);
...
557: if (local_f0 == 0) {
558: local_f0 = 1;
559: if (*local_f8 != 0) goto LAB_00407163;
560: if (uStack228 != 0) goto LAB_00406ec1;
561: }
...
575: if (uVar15 * 5 <= local_1c0) goto LAB_004066e9;
576: bVar3 = true;
577: }
...
588: if (iVar6 == 0) goto LAB_00406821;
589: }
590: }
591: LAB_00406a39:
