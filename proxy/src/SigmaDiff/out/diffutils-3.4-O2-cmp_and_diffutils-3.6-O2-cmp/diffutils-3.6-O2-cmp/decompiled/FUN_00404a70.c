1: 
2: ulong FUN_00404a70(byte *param_1,byte **param_2,uint param_3,ulong *param_4,char *param_5)
3: 
4: {
5: byte bVar1;
6: byte bVar2;
...
49: else {
50: uVar9 = 1;
51: if (*piVar6 != 0x22) goto LAB_00404aee;
52: }
53: uVar12 = (uint)uVar9;
54: if ((param_5 != (char *)0x0) && (bVar1 = *pbVar8, bVar1 != 0)) {
55: pcVar11 = strchr(param_5,(int)(char)bVar1);
56: if (pcVar11 != (char *)0x0) goto LAB_00404b8f;
57: switchD_00404d00_caseD_1:
58: *param_4 = uVar10;
59: uVar9 = (ulong)(uVar12 | 2);
60: goto LAB_00404af3;
61: }
62: LAB_00404b58:
63: *param_4 = uVar10;
64: goto LAB_00404af3;
65: }
...
81: goto LAB_00404cef;
82: }
83: if (bVar2 != 0x42) {
84: /* WARNING: Could not recover jumptable at 0x00404bfa. Too many branches */
85: /* WARNING: Treating indirect jump as call */
86: uVar10 = (*(code *)(&PTR_LAB_00408b58)[bVar15])();
87: return uVar10;
88: }
89: }
90: iVar13 = 2;
...
109: break;
110: default:
111: goto switchD_00404d00_caseD_1;
112: case 3:
113: iVar14 = 6;
114: uVar16 = 0;
115: do {
...
148: ZEXT816((ulong)(long)iVar5),0) < uVar10) goto LAB_00404dc0;
149: LAB_00404cc7:
...
226: break;
227: case 0x20:
228: if (0x7fffffffffffff < uVar10) goto LAB_00404dc0;
229: uVar10 = uVar10 << 9;
230: uVar16 = 0;
231: break;
232: case 0x21:
...
234: break;
235: case 0x35:
236: if ((long)uVar10 < 0) goto LAB_00404dc0;
237: uVar10 = uVar10 * 2;
238: uVar16 = 0;
239: }
