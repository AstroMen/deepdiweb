1: 
2: void FUN_00402990(int param_1,char **param_2,char param_3)
3: 
4: {
5: char *pcVar1;
6: int iVar2;
...
13: iVar2 = FUN_00404a70(pcVar1,param_2,0,&local_38,"kKMGTPEZY0");
...
21: }
22: else {
23: FUN_00402930("invalid --ignore-initial value \'%s\'",pcVar1);
24: }
