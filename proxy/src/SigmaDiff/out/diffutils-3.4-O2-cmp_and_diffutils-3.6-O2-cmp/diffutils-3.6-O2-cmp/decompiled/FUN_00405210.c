...
35: __s1 = "";
36: }
37: if (DAT_0060c460 != (char *)0x0) goto LAB_0040527a;
...
79: if (__stream->_IO_read_end <= pbVar9) goto LAB_0040553c;
80: do {
...
84: while( true ) {
85: __s2 = pcVar7;
86: if ((uVar5 - 9 < 2) || (uVar5 == 0x20)) goto LAB_004053e0;
87: if (uVar5 == 0x23) goto LAB_00405585;
88: ungetc(uVar5,__stream);
89: iVar3 = fscanf(__stream,"%50s %50s",local_b8);
90: if (iVar3 < 2) goto LAB_0040554f;
91: puVar12 = local_b8;
92: do {
93: puVar11 = puVar12;
...
144: pcVar7 = __s2;
145: if (uVar5 == 0xffffffff) goto LAB_0040554f;
146: }
147: } while( true );
148: }
149: close(iVar3);
150: }
151: goto LAB_004055be;
152: }
153: }
154: __s2 = "";
...
191: if (uVar5 == 0xffffffff) goto LAB_0040554f;
192: goto LAB_004053e0;
193: LAB_0040554f:
194: fclose(__stream);
195: if (local_c8 == 0) {
196: LAB_004055be:
