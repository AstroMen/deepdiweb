...
export const SHOW_RAWVIEWFORM_PANEL = 'show.rawviewform.panel' // Constant for RawView's second tab table
export const SHOW_STRINGS_PANEL = 'show.strings.panel'
export const OPEN_LISTING_TAB = 'open.listing.tab'
export const SHOW_RAWMODE_PANEL = 'show.rawmode.panel' // Constant for RawView's first tab
